    ...
    <div className="login-screen">
      ...
      <div className="login-instructions">
        <div className="instructions">
          ...
          <p>GRUNTY'S FURNACE FUN ISN'T OVER! HELP EVERYONE'S FAVOURITE BEAR AND BIRD COMPLETE GRUNTILDA'S CONCENTRATION GAME. YOU'LL HAVE A NUMBER OF TRIES TO TRY AND PAIR UP ALL THE MATCHING CARDS.</p>
